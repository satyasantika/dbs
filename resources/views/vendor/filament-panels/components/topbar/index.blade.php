...
>
    ...
    >
        ...
        {{-- Sidebar header merged into the topbar: desktop collapse/expand toggle
             sits at the far left, immediately next to the logo. --}}
        @if (filament()->hasNavigation() && (! filament()->hasTopNavigation()))
            <div class="fi-topbar-start flex items-center gap-x-3">
                @if (filament()->isSidebarCollapsibleOnDesktop())
                    <div class="fi-topbar-collapse-sidebar-btn-ctn hidden lg:flex">
                        <x-filament::icon-button
                            color="gray"
                ...
                {{-- Shown only while the sidebar is collapsed — when it's expanded,
                     the sidebar's own header already carries the logo, so showing
                     it here too would just duplicate it. --}}
        ...
        >
            ...
            {{-- Global search intentionally disabled in this merged topbar. --}}
